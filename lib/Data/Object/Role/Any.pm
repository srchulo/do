# ABSTRACT: Any Object Role for Perl 5
package Data::Object::Role::Any;
...
my $func = &$dispatch('Data::Object::Config::Any');
...
=head1 SYNOPSIS
  ...
  with 'Data::Object::Role::Any';

=cut

=head1 DESCRIPTION

Data::Object::Role::Any provides routines for operating on any Perl 5
data type.
...
=method new
  ...
  my $object = Data::Object::Any->new($scalar);
